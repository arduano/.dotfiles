...

{
  ...
  # The standalone flake owns Wine, installer identity, clean prefix
  # bootstrap, desktop/OAuth integration, and transactional rollback.
  programs.makera-studio.enable = true;
